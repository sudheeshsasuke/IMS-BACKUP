...
class database {
    ...
    public function open_database_connection()
    {
        ...
        $server = 'localhost';
        $dbname = 'interview_management_system_v2';
        $username = 'root';
        $password = 'root';
    ...
    */
    public function query_execute($query, $values) {
     ...
     /*  
    *   Incomplete functions dont use it
    * 
    */
    ...
    */
    ...
    /*
    *   query prepare () which can handle only select and update
    *   @params
    */
    ...
    */
    public function execute() {
        $this->execution_status = $this->result->execute();
        return $this;
    }

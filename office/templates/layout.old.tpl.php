...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="http://ims.com/office/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="http://ims.com/office/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="http://ims.com/office/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="http://ims.com/office/bower_components/bootstrap-daterangepicker/daterangepicker.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>I</b>MAN</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Interview</b>Management</span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <!--.........MESSAGES menu can be include here............-->

          
          <!-- Notifications: style can be found in dropdown.less -->
          <!--..............NOTIFIACATION menu can be included here.................-->
         
         
          <!-- Tasks: style can be found in dropdown.less -->
          <!-- ...............TASK completion menu can be included here........-->
...
<!-- Morris.js charts -->
<script src="http://ims.com/office/bower_components/raphael/raphael.min.js"></script>
<script src="http://ims.com/office/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
<script src="http://ims.com/office/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script src="http://ims.com/office/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="http://ims.com/office/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="http://ims.com/office/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="http://ims.com/office/bower_components/moment/min/moment.min.js"></script>
<script src="http://ims.com/office/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="http://ims.com/office/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
<!-- Bootstrap WYSIHTML5 -->

          ...
          <tr>
            ...
            <?php foreach($IR as $intround) :?>
              <?php foreach($intround as $round) :?>
                <td><?=htmlentities($score[$participant['part_id']][$round['id']]['score'])?></td>
                <td><?=htmlentities($score[$participant['part_id']][$round['id']]['status'])?></td>
                <td><?=htmlentities($score[$participant['part_id']][$round['id']]['comment'])?></td>
              <?php endforeach;?>
            <?php endforeach;?>

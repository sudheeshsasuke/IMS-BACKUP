                          ...
                          <li > 
                            <div class="list-interview">
                              <h3 class="interviewtitle">
                                <a class ="<?= $interview['id'];?>" href="http://ims.com/user/applied_for_interview?interview_id=<?php echo $results['id']?>&flag=1">
                              ...
                              <div class="interviewstatus">
                                <p><?php echo strtoupper(htmlentities($results['status']));?></p>
                              </div>

...
class Rounds extends database {
    ...
    public function add_round() {
        $query = "INSERT INTO rounds (name,max_score) VALUES(:na,:ms)";
        $values = array(':na' => $_POST['roundname'],':ms'=>$_POST['maxscore']);
    ...
    public function edit_round() {
        $query = "UPDATE rounds set name = :na,max_score = :ms WHERE id = :id";
        $values = array(
            ':id'=> $_POST['roundid'],
            ':na' => $_POST['roundname'],
            ':ms'=> $_POST['maxscore']);

...
<meta name="google-signin-client_id" content="954781805397-vgrd061a992gdn9c4r7d3rum4m72303v.apps.googleusercontent.com">
  ...
  <script src="http://ims.com/user/js/status.js"></script>	
  <script>
    ...
    <?php if(!isset($_SESSION['gmail'])): ?>
        ...
        function onSignIn(googleUser) {
           ...
           // alert(id_token);
            ...
            googlelogininsertion(id_token);
        }
    <?php endif; ?>

    //google login
    function googlelogininsertion(id_token) {
            //alert(email);
            //alert(name);
            //var flag = 1;
   ...
   // $(document).ready(function() {
        function signOut() {
            ...
            auth2.signOut().then(function () {
                    ...
                    //alert("hi");
                    window.location = "http://ims.com/user/logout";
                    //alert("hi");
            });
      }
                        ...
                        <div class="col-md-8" style="border-right: 1px dotted #C2C2C2;padding-right: 30px;">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="Login">
                                    <form id="Loginform" role="form" method="post" action="http://ims.com/user/login" class="form-horizontal">
                                    <div style="margin-top:10px;" class="form-group">
                                        <label for="email" class="col-sm-2 control-label">
                                            Email</label>
                                        <div class="col-sm-10">
                                            <input type="email" class="form-control" name="loginemail" id="email1" placeholder="Email"   required/>
                                        </div>
                                    </div>
                                    <div style="margin-top:10px;" class="form-group">
                                        <label for="exampleInputPassword1" class="col-sm-2 control-label">
                                            Password</label>
                                        <div class="col-sm-10">
                                            <input type="password" class="form-control" name="loginpassword" id="exampleInputPassword1" placeholder="password"    required/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-2">
                                ...
                                <div class="tab-pane" id="Registration">
                                    ...
                                    <div class="form-group">
                                        <label for="mobile" class="col-sm-2 control-label">
                                            Mobile</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="mobile" id="mobile" placeholder="Mobile" min="0" max="10"   required/>
                                        </div>
                                    </div>
                                    <div class="form-group">
